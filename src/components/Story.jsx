...
const Story = (props) => {
    ...
    return (
        <Link to={`/story/${unique_id}/${stripped}`} className='xui-bdr-w-1 xui-bdr-fade xui-bdr-s-solid xui-overflow-hidden xui-text-dc-none xui-text-inherit dap-story-box'>
            <div className='xui-p-1 xui-lg-p-1-half'>
                ...
                <h2 className={'bebas-neue-regular xui-font-sz-200 xui-lg-font-sz-200 xui-my-2 ' + (skeleton && 'xui--skeleton')}>{heading}</h2>
            </div>
